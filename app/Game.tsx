...
const BASE: Company[] = [
  ...
  { name: "Alphabet (Google)", ticker: "GOOGL", domain: "google.com", cap: 2470, country: "US" },
  { name: "Amazon", ticker: "AMZN", domain: "amazon.com", cap: 2460, country: "US" },
  { name: "Meta", ticker: "META", domain: "meta.com", cap: 1970, country: "US" },
  { name: "Berkshire Hathaway", ticker: "BRK.A", domain: "berkshirehathaway.com", cap: 1030, country: "US" },
  { name: "Eli Lilly", ticker: "LLY", domain: "lilly.com", cap: 630, country: "US" },
  { name: "TSMC", ticker: "TSM", domain: "tsmc.com", cap: 1020, country: "TW" },
  { name: "Tesla", ticker: "TSLA", domain: "tesla.com", cap: 1070, country: "US" },
  { name: "Broadcom", ticker: "AVGO", domain: "broadcom.com", cap: 1440, country: "US" },
  { name: "Novo Nordisk", ticker: "NVO", domain: "novonordisk.com", cap: 227, country: "DK" },
  { name: "Visa", ticker: "V", domain: "visa.com", cap: 664, country: "US" },
  { name: "JPMorgan", ticker: "JPM", domain: "jpmorganchase.com", cap: 799, country: "US" },
  { name: "ExxonMobil", ticker: "XOM", domain: "exxon.com", cap: 454, country: "US" },
  { name: "ASML", ticker: "ASML", domain: "asml.com", cap: 270, country: "NL" },
  { name: "Walmart", ticker: "WMT", domain: "walmart.com", cap: 798, country: "US" },
  { name: "Mastercard", ticker: "MA", domain: "mastercard.com", cap: 526, country: "US" },
  { name: "LVMH", ticker: "MC.PA", domain: "lvmh.com", cap: 260, country: "FR" },
  { name: "Johnson & Johnson", ticker: "JNJ", domain: "jnj.com", cap: 425, country: "US" },
  { name: "Procter & Gamble", ticker: "PG", domain: "pg.com", cap: 362, country: "US" },
  { name: "Nestlé", ticker: "NESN.SW", domain: "nestle.com", cap: 231, country: "CH" },
  { name: "Costco", ticker: "COST", domain: "costco.com", cap: 431, country: "US" },
  { name: "Tencent", ticker: "0700.HK", domain: "tencent.com", cap: 689, country: "CN" },
  { name: "Home Depot", ticker: "HD", domain: "homedepot.com", cap: 397, country: "US" },
  { name: "Toyota", ticker: "7203.T", domain: "toyota-global.com", cap: 253, country: "JP" },
  { name: "Chevron", ticker: "CVX", domain: "chevron.com", cap: 318, country: "US" },
  { name: "AbbVie", ticker: "ABBV", domain: "abbvie.com", cap: 365, country: "US" },
  { name: "AMD", ticker: "AMD", domain: "amd.com", cap: 288, country: "US" },
  { name: "Roche", ticker: "ROG.SW", domain: "roche.com", cap: 220, country: "CH" },
  { name: "Novartis", ticker: "NOVN.SW", domain: "novartis.com", cap: 241, country: "CH" },
  { name: "Adobe", ticker: "ADBE", domain: "adobe.com", cap: 151, country: "US" },
  { name: "Netflix", ticker: "NFLX", domain: "netflix.com", cap: 526, country: "US" },
  { name: "Salesforce", ticker: "CRM", domain: "salesforce.com", cap: 232, country: "US" },
  { name: "SAP", ticker: "SAP", domain: "sap.com", cap: 323, country: "DE" },
  { name: "McDonald's", ticker: "MCD", domain: "mcdonalds.com", cap: 220, country: "US" },
  { name: "Coca‑Cola", ticker: "KO", domain: "coca-cola.com", cap: 301, country: "US" },
  { name: "PepsiCo", ticker: "PEP", domain: "pepsico.com", cap: 206, country: "US" },
  { name: "Intel", ticker: "INTC", domain: "intel.com", cap: 108, country: "US" },
  { name: "Nike", ticker: "NKE", domain: "nike.com", cap: 114, country: "US" },
  { name: "Pfizer", ticker: "PFE", domain: "pfizer.com", cap: 143, country: "US" },
  { name: "TotalEnergies", ticker: "TTE", domain: "totalenergies.com", cap: 137, country: "FR" },
  { name: "Siemens", ticker: "SIE.DE", domain: "siemens.com", cap: 219, country: "DE" },
  { name: "Airbus", ticker: "AIR.PA", domain: "airbus.com", cap: 172, country: "FR" },
  { name: "Boeing", ticker: "BA", domain: "boeing.com", cap: 178, country: "US" },
  { name: "BP", ticker: "BP.L", domain: "bp.com", cap: 91, country: "UK" },
  { name: "BYD", ticker: "1211.HK", domain: "byd.com", cap: 129, country: "CN" },
  { name: "IBM", ticker: "IBM", domain: "ibm.com", cap: 223, country: "US" },
  { name: "Volkswagen", ticker: "VOW3.DE", domain: "volkswagen.com", cap: 60, country: "DE" },
  { name: "Ferrari", ticker: "RACE", domain: "ferrari.com", cap: 112, country: "IT" },
  { name: "Xiaomi", ticker: "1810.HK", domain: "mi.com", cap: 176, country: "CN" },
  { name: "Spotify", ticker: "SPOT", domain: "spotify.com", cap: 151, country: "US" },
  { name: "Snowflake", ticker: "SNOW", domain: "snowflake.com", cap: 66, country: "US" },
  { name: "ServiceNow", ticker: "NOW", domain: "servicenow.com", cap: 180, country: "US" },
];

const EXTRA: Company[] = [
  // Tech & Semis
  { name: "Oracle", ticker: "ORCL", domain: "oracle.com", cap: 697, country: "US" },
  { name: "Cisco", ticker: "CSCO", domain: "cisco.com", cap: 262, country: "US" },
  { name: "Qualcomm", ticker: "QCOM", domain: "qualcomm.com", cap: 170, country: "US" },
  { name: "Texas Instruments", ticker: "TXN", domain: "ti.com", cap: 177, country: "US" },
  { name: "Applied Materials", ticker: "AMAT", domain: "appliedmaterials.com", cap: 130, country: "US" },
  { name: "Lam Research", ticker: "LRCX", domain: "lamresearch.com", cap: 126, country: "US" },
  { name: "KLA", ticker: "KLAC", domain: "kla.com", cap: 115, country: "US" },
  { name: "Micron", ticker: "MU", domain: "micron.com", cap: 135, country: "US" },
  { name: "Marvell", ticker: "MRVL", domain: "marvell.com", cap: 66, country: "US" },
  { name: "Arm", ticker: "ARM", domain: "arm.com", cap: 147, country: "UK" },
  { name: "Sony", ticker: "6758.T", domain: "sony.com", cap: 174, country: "JP" },
  { name: "Nintendo", ticker: "7974.T", domain: "nintendo.com", cap: 114, country: "JP" },
  { name: "HP Inc.", ticker: "HPQ", domain: "hp.com", cap: 25, country: "US" },
  { name: "Dell Technologies", ticker: "DELL", domain: "dell.com", cap: 94, country: "US" },
  { name: "Lenovo", ticker: "0992.HK", domain: "lenovo.com", cap: 17, country: "CN" },
  { name: "Acer", ticker: "2353.TW", domain: "acer.com", cap: 3, country: "TW" },
  { name: "ASUS", ticker: "2357.TW", domain: "asus.com", cap: 16, country: "TW" },
  { name: "Uber", ticker: "UBER", domain: "uber.com", cap: 193, country: "US" },
  { name: "Airbnb", ticker: "ABNB", domain: "airbnb.com", cap: 78, country: "US" },
  { name: "Booking Holdings", ticker: "BKNG", domain: "bookingholdings.com", cap: 177, country: "US" },
  { name: "Shopify", ticker: "SHOP", domain: "shopify.com", cap: 184, country: "CA" },
  { name: "MercadoLibre", ticker: "MELI", domain: "mercadolibre.com", cap: 121, country: "AR" },
  { name: "Sea Limited", ticker: "SE", domain: "sea.com", cap: 105, country: "SG" },
  { name: "Tencent Music", ticker: "TME", domain: "tencentmusic.com", cap: 44, country: "CN" },
  { name: "Palantir", ticker: "PLTR", domain: "palantir.com", cap: 418, country: "US" },
  { name: "Atlassian", ticker: "TEAM", domain: "atlassian.com", cap: 44, country: "AU" },
  { name: "MongoDB", ticker: "MDB", domain: "mongodb.com", cap: 18, country: "US" },
  { name: "Datadog", ticker: "DDOG", domain: "datadoghq.com", cap: 44, country: "US" },
  { name: "Cloudflare", ticker: "NET", domain: "cloudflare.com", cap: 70, country: "US" },
  { name: "Akamai", ticker: "AKAM", domain: "akamai.com", cap: 11, country: "US" },
  { name: "Zoom", ticker: "ZM", domain: "zoom.us", cap: 22, country: "US" },
  { name: "Samsung Electronics", ticker: "005930.KS", domain: "samsung.com", cap: 337, country: "KR" },

  // Internet & China
  { name: "Alibaba", ticker: "BABA", domain: "alibaba.com", cap: 289, country: "CN" },
  { name: "JD.com", ticker: "9618.HK", domain: "jd.com", cap: 44, country: "CN" },
  { name: "PDD Holdings", ticker: "PDD", domain: "pddholdings.com", cap: 166, country: "CN" },
  { name: "Baidu", ticker: "9888.HK", domain: "baidu.com", cap: 31, country: "CN" },
  { name: "Meituan", ticker: "3690.HK", domain: "meituan.com", cap: 95, country: "CN" },
  { name: "NetEase", ticker: "9999.HK", domain: "neteasegames.com", cap: 84, country: "CN" },
  { name: "Kuaishou", ticker: "1024.HK", domain: "kuaishou.com", cap: 41, country: "CN" },

  // Payments & Fintech
  { name: "PayPal", ticker: "PYPL", domain: "paypal.com", cap: 66, country: "US" },
  { name: "Block (Square)", ticker: "SQ", domain: "block.xyz", cap: 47, country: "US" },
  { name: "Adyen", ticker: "ADYEN.AS", domain: "adyen.com", cap: 51, country: "NL" },
  { name: "Fiserv", ticker: "FISV", domain: "fiserv.com", cap: 74, country: "US" },
  { name: "Fidelity National Info", ticker: "FIS", domain: "fisglobal.com", cap: 37, country: "US" },
  { name: "Global Payments", ticker: "GPN", domain: "globalpayments.com", cap: 21, country: "US" },
  { name: "Intuit", ticker: "INTU", domain: "intuit.com", cap: 200, country: "US" },
  { name: "Coinbase", ticker: "COIN", domain: "coinbase.com", cap: 82, country: "US" },

  // Banking & Asset Mgmt
  { name: "Bank of America", ticker: "BAC", domain: "bankofamerica.com", cap: 348, country: "US" },
  { name: "Wells Fargo", ticker: "WFC", domain: "wellsfargo.com", cap: 247, country: "US" },
  { name: "Citigroup", ticker: "C", domain: "citigroup.com", cap: 172, country: "US" },
  { name: "Goldman Sachs", ticker: "GS", domain: "goldmansachs.com", cap: 221, country: "US" },
  { name: "Morgan Stanley", ticker: "MS", domain: "morganstanley.com", cap: 231, country: "US" },
  { name: "American Express", ticker: "AXP", domain: "americanexpress.com", cap: 213, country: "US" },
  { name: "S&P Global", ticker: "SPGI", domain: "spglobal.com", cap: 170, country: "US" },
  { name: "Moody's", ticker: "MCO", domain: "moodys.com", cap: 93, country: "US" },
  { name: "BlackRock", ticker: "BLK", domain: "blackrock.com", cap: 176, country: "US" },
  { name: "Blackstone", ticker: "BX", domain: "blackstone.com", cap: 127, country: "US" },
  { name: "Charles Schwab", ticker: "SCHW", domain: "schwab.com", cap: 174, country: "US" },
  { name: "UBS", ticker: "UBSG.SW", domain: "ubs.com", cap: 128, country: "CH" },
  { name: "Deutsche Bank", ticker: "DBK.DE", domain: "db.com", cap: 70, country: "DE" },
  { name: "HSBC", ticker: "HSBA.L", domain: "hsbc.com", cap: 223, country: "UK" },
  ...
  // Insurance
  { name: "Allianz", ticker: "ALV.DE", domain: "allianz.com", cap: 170, country: "DE" },
  { name: "AXA", ticker: "CS.PA", domain: "axa.com", cap: 100, country: "FR" },
